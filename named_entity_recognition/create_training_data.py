...
def generate_artists_td(
    albums_data: list, artists_data: list, songs_data: list
) -> list:
    """
...
convert_to_spacy("data/training_data.json", "data/training_data.spacy")
...
export_data_to_json(
    ...
    artists_data_val,
    genres_data_val,
    instruments_data_val,
    songs_data_val,
)
convert_to_spacy("data/validation_data.json", "data/validation_data.spacy")
